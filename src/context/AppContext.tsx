...
const translations = {
  pt: {
    ...
    ready: "Tudo pronto!",
    readyHelp: "Sua proposta está configurada. Após salvar, você poderá baixar o PDF completo.",
  ...
  en: {
    ...
    ready: "All ready!",
    readyHelp: "Your proposal is configured. After saving, you can download the complete PDF.",
